<div class="theme-steps-list">
	...
	<div class="theme-steps">
		<h3><?php echo esc_html__('Step 1 - Read Full Documentation', 'enlighten'); ?></h3>
		...
		<a class="button" href="<?php echo esc_url('http://doc.accesspressthemes.com/enlighten-documentation/'); ?>"><?php echo esc_html__('Read Documentation', 'enlighten'); ?></a>
	</div>
