			...
			if($plugin['bundled'] == false) {
				...
				if(!isset($info->errors)) :
					...
					<div class="action-tab warning">
						<h3><?php /* translators: %s : plugin name */ printf( esc_html__("Install : %s Plugin", 'enlighten'), esc_html($info->name) ); ?></h3>
				...
				?>
				<div class="action-tab warning">
					<h3><?php /* translators: %s : plugin name */ printf( esc_html__("Install : %s Plugin", 'enlighten'), esc_html($plugin['name']) ); ?></h3>
