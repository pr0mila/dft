...
function enlighten_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($enlighten_widgets_field_type) {
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($enlighten_widgets_name)); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?>:</label>
                <textarea class="widefat" rows="<?php echo esc_attr($enlighten_widgets_row); ?>" id="<?php echo esc_attr($instance->get_field_id($enlighten_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($enlighten_widgets_name)); ?>"><?php echo wp_kses_post($athm_field_value); ?></textarea>
            </p>
            <?php
            break;
