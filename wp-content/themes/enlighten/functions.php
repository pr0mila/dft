 ...
 */
function enlighten_editor_styles() {
	$query_args = array('family' => 'Open+Sans:400,600,700|Raleway:400,600,300,700,400italic,500italic|Titillium+Web:400,300,200,600,400italic|Oswald|Lato:400,100,100italic,300,300italic,400italic,700,700italic,900');

    wp_enqueue_style( 'enlighten-lite-google-fonts', add_query_arg( $query_args, "//fonts.googleapis.com/css" ) );

    wp_enqueue_style( 'enlighten-lite-editor-style', get_template_directory_uri() . '/css/style-editor.css' );
}
add_action( 'enqueue_block_editor_assets', 'enlighten_editor_styles' );
